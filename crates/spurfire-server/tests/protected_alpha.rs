...
use spurfire_server::{
    ...
    ProtectedAlphaVerificationContext, PROTECTED_ALPHA_AUDIENCE, PROTECTED_ALPHA_PURPOSE,
};
...
async fn protected_public_router_has_only_literal_authorized_lobby_paths() {
    ...
    let claims = ProtectedAlphaClaims {
        ...
        final_io_deadline: UnixMillis::new(40_000),
        absolute_deadline: UnixMillis::new(50_000),
